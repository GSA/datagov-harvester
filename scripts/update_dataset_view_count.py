...
def get_ga_credentials():
    ga_creds = os.getenv("GA_CREDENTIALS", {})
    if ga_creds:
        ga_creds = ga_creds.replace("\n", "")
        ga_creds = ga_creds[1:]  # the str starts with "="
    return json.loads(ga_creds)


# google analytics data
GA_CREDENTIALS = get_ga_credentials()
...
def main():
    ...
    interface.insert_view_counts_of_datasets(datasets)
