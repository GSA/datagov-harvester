...
test-unit: ## Runs unit tests. Compatible with dev environment / `make up`
	poetry run pytest  --cov-report term-missing --cov-report xml:pytest-unit.xml --cov=harvester ./tests/unit

test-integration: ## Runs integration tests. Compatible with dev environment / `make up`
	poetry run pytest --cov-report term-missing --cov-report xml:pytest-integration.xml --cov=harvester ./tests/integration

test-functional: ## Runs integration tests. Compatible with dev environment / `make up`
	poetry run pytest --noconftest --cov-report term-missing --cov-report xml:pytest-functional.xml --cov=harvester ./tests/functional
