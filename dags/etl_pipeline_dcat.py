...
DAILY_HARVEST_SOURCE = CURRENT_DIR / "sources/dcatus/daily_sample.json"
...
def create_dag(dag_id, schedule, default_args, tags, source):
    ...
    def etl_pipeline():
        ...
        compared_record=compare.expand(dcatus_record=extracted_record)
        transformed_record=transform.expand(dcatus_record=compared_record)
